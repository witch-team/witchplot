...
output$select_variable <- renderUI({selectInput("variable_selected", "Select variable", list_of_variables, size=1, selectize=FALSE, multiple=FALSE, selected=list_of_variables[1])})
